...
//            'prefix' => 'ty_',
        ...
        'baidu_riders' => [
            'driver' => 'mysql',
            'host' => env('BAIDU_DB_HOST', '127.0.0.1'),
            'port' => env('BAIDU_DB_PORT', '3306'),
            'database' => env('BAIDU_DB_DATABASE', 'baidu_riders'),
            'username' => env('BAIDU_DB_USERNAME', 'root'),
            'password' => env('BAIDU_DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
