    ...
    <div id="content-wrapper">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span>关系信息</span></li>
            </ol>
            <div class="main-box clearfix">
                <header class="main-box-header clearfix">
                    <h2 class="pull-left">关系列表</h2>
                    <div class="filter-block pull-right" style="margin-right: 20px;">
                        ...
                        <button class="md-trigger btn btn-primary" data-modal="modal-8">添加关系信息</button>
                    </div>
                </header>
        ...
        <div class="md-modal md-effect-8 md-hide" id="modal-8">
            <div class="md-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">关系信息添加</h4>
                </div>
                <div class="modal-body">
                    <form role="form" id="form-store" action='{{ route('api_option.relationship.store') }}' method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" placeholder="关系名称（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
                            <label for="number">关系编码</label>
                            <input class="form-control" name="number" placeholder="关系编码（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
                            <label for="code">关系代号</label>
                            <input class="form-control" name="code" placeholder="关系代号（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
