    ...
    <div id="content-wrapper">
        <div class="col-lg-12">
            <ol class="breadcrumb">
                ...
                <li class="active"><span>证件信息</span></li>
            </ol>
            <div class="main-box clearfix">
                <header class="main-box-header clearfix">
                    <h2 class="pull-left">证件类型列表</h2>
                    <div class="filter-block pull-right" style="margin-right: 20px;">
                        ...
                        <button class="md-trigger btn btn-primary" data-modal="modal-8">添加证件类型信息</button>
                    </div>
                </header>
        ...
        <div class="md-modal md-effect-8 md-hide" id="modal-8">
            <div class="md-content">
                ...
                <div class="modal-body">
                    <form role="form" id="form-store" action='{{ route('api_option.card_type.store') }}' method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <label for="name">证件类型名称</label>
                            <input class="form-control" name="name" placeholder="证件类型名称（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
                            <label for="number">证件类型编码</label>
                            <input class="form-control" name="number" placeholder="证件类型编码（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
                            <label for="code">证件类型代号</label>
                            <input class="form-control" name="code" placeholder="证件类型代号（应少于255个字符长度）" type="text">
                        </div>
                        <div class="form-group">
