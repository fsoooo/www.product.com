				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li class="active"><span>模板详情</span></li>
						</ol>
					</div>
				</div>
				<div class="row">
												...
												<form action="{{ url('/backend/sms/send_message') }}" method="post" id="send-message-form">
													...
													<table id="user" class="table table-hover" style="clear: both">
														...
														<tr>
															<td width="15%">模板编码</td>
															<td width="60%">
																<input type="text" class="form-control"  id="name" name="name" value="{{$res[0]->model_id}}" readonly="readonly" >
															</td>
														</tr>
														<tr>
															<td width="15%">模板名称</td>
															<td width="60%">
																<input type="text" class="form-control"  id="name" name="name" value="{{$res[0]->model_name}}" readonly="readonly" >
															</td>
														</tr>
														<tr>
															<td>标签内容</td>
