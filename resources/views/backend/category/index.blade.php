                ...
                <div class="modal-body">
                    <form role="form" id="add_category" action='{{url('backend/product/category/add')}}' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" placeholder="分类名称（5-50个字符长度）" type="text">
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-body">
                    <form role="form" id="add_son_category" action='{{url('backend/product/category/add')}}' method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="p_category_name" class="form-control" placeholder="分类名称（5-50个字符长度）" type="text" disabled>
                        </div>
        ...
        <div class="md-content">
            ...
            <div class="modal-body">
                <form role="form" id="alter_category" action='{{url('backend/product/category/alter')}}' method="get">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">分类名称</label>
                        <input id="alter_category_name" class="form-control" name="name" placeholder="分类名称（5-50个字符长度）" type="text">
        ...
        $(function(){
            ...
            $("tr").on("click", function () {
                ...
                if (!$(this).prop("checked")) {
                    var tmp = $(this).nextUntil("tr.sort-"+$sort).filter("tr.sort-"+$next);
                    if (tmp.length > 0) {
                        tmp.show();
                    ...
                    $(this).nextUntil("tr.sort-"+$sort).filter("tr.sort-"+$next).hide();
