                        ...
                        <div class="main-box clearfix" style="min-height: 1100px;">
                            <div class="tabs-wrapper tabs-no-header">
                                <ul class="nav nav-tabs">
                                    @if($order_detail->claim_type == 'online')
                                    ...
                                    @elseif($order_detail->claim_type == 'offline')
                                        <li><a href="{{ url('backend/order/get_order/all') }}">订单列表</a></li>
                                                ...
                                                <form id="warranty-form" action="{{ url('/backend/warranty/add_warranty_submit') }}" method="post">
                                                    ...
                                                    <table id="user" class="table table-hover" style="clear: both">
                                                        ...
                                                        <tr>
                                                            <td width="25%">订单编号</td>
                                                            <td width="60%">
                                                                {{ $order_detail->warranty_rule_order->order_code }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td width="25%">投保单号</td>
                                                            <td width="60%">
                                                                {{ $order_detail->union_order_code }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>所属保险公司</td>
                                                            <td>
                                                                {{ $order_detail->warranty_product->company_name }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>产品名称</td>
                                                            <td>
                                                                {{ $order_detail->warranty_product->product_name }}
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <div class="panel panel-default">
                                                <table id="user" class="table table-hover" style="clear: both">
                                                    ...
                                                    <tr>
                                                        <td>职业</td>
                                                        <td>
                                                            {{ $policy_detail->policy_occupation->name }}
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <div class="panel panel-default">
                                                    <table id="user" class="table table-hover" style="clear: both">
                                                        ...
                                                        <tr>
                                                            <td>与投保人关系</td>
                                                            <td>
                                                                {{ $value->recognizee_relation->name }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>证件号码</td>
                                                        ...
                                                        <tr>
                                                            <td>职业</td>
                                                            <td>
                                                                {{ $value->recognizee_occupation->name }}
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
