                    ...
                    <div class="col-lg-12">
                            <div class="col-lg-12">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active"><a href="{{ url('/backend/special/special') }}">已发工单</a></li>
                                </ol>
                            </div>
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table user-list table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 20%;">
                                                        <a href="specialinfo?id={{$value['id']}}" class="table-link"><span class="fa-stack"><i class="fa fa-square fa-stack-2x"></i><i class="fa fa-search-plus fa-stack-1x fa-inverse"></i></span>
                                                        </a>
