                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ol class="breadcrumb">
                            ...
                            <li class="active"><span>添加客户统计</span></li>
                        </ol>
                    </div>
                </div>
                <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="main-box clearfix">
                    <header class="main-box-header clearfix">
                        <h2 class="pull-left">添加客户统计列表</h2>
                    </header>
                                    ...
                                    @else
                                        @foreach ( $data as $value )
                                            <tr>
                                                ...
                                                {{--<td><a  class="label label-success" href="{{ url('/backend/relation/evolve/'.$value->code.'/'.$value->id) }}" style="color:white;">查看</a></td>--}}
                                                {{--<td>--}}
                                                    {{--<a href="{{ url('/backend/boss/business/get_cust_detail') }}">查看</a>--}}
                                                {{--</td>--}}
                                            </tr>
                                        @endforeach
                                    @endif
