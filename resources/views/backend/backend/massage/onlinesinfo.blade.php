				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><span><a href="{{ url('/backend/sms/onlineservice')}}">在线客服</a></span></li>
							<li><a href="{{ url('/backend/sms/onlineservice')}}">客服列表</a></li>
							<li class="active">客服详情</li>
						</ol>
					</div>
				</div>
				<div class="row">
						...
						<div class="main-box clearfix" style="min-height: 1100px;">
							<div class="tabs-wrapper tabs-no-header">
								{{--<ul class="nav nav-tabs">--}}
									{{--<li class="active"><a href="{{ url('/backend/sms/onlineservice')}}">列表</a></li>--}}
									{{--<li ><a href="{{ url('/backend/sms/addonlines') }}">添加</a></li>--}}
								{{--</ul>--}}
