...
//        dd($input);exit;
        ...
        if(isset($ty_t_values['ty_toubaoren_area'])){
            ...
            //直辖市 2级处理
            $area_toubaoren = str_replace(['-110100','-120100','-310100','-500100'],'',$area_toubaoren);
        }
        ...
        foreach($ty_b_values as $bk => $bv){
            if(isset($bv['ty_beibaoren_area'])){
                ...
                //直辖市 2级处理
                $bv['area'] = str_replace(['-110100','-120100','-310100','-500100'],'',$bv['area']);
            }
            ...
            if($relation == 1){ //关系为本人
                ...
                $insurants[]= [
                    ...
                    "contactAddress" => isset($bv['ty_beibaoren_address']) ? $bv['ty_beibaoren_address'] : '',
                    "contactPost" => $bv['ty_beibaoren_contact_post'] ?? '',         //邮编
                    "count" => 1   //购买份数
                ];
            }
        }
