...
//        dd($quote_selected);
        ...
        $orderMain['agrtCode'] = $productCode . '000';            //外部产品协议码
...
//                    'wechatPay'=> '微信支付'
    ...
    public function getPayWayInfo()
    {
        ...
        $data['agrtCode'] = $ins_order->p_code.'000';  //协议号
...
//        $this->testExcel();
    ...
    {
        $a = ExcelHelper::excelToArray("upload/tariff/ya_w_test.xlsx");
        ...
        DB::table('tariff_ya_exbw')->insert($insert_data);
    }
