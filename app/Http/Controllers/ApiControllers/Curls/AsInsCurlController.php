...
//        $this->testExcel();
        ...
        {
            case $this->product_codes_cxwy:
                $quote = DB::table('tariff_ya_cxwy')->where($where)->first();
                break;
            case $this->product_codes_exbw:
                $quote = DB::table('tariff_ya_exbw')->where($where)->first();
                break;
            case $this->product_codes_exyd:
                $quote = DB::table('tariff_ya_exyd')->where($where)->first();
                break;
        }
    ...
    {
        $a = ExcelHelper::excelToArray("upload/tariff/ya_exyd.xlsx");
        ...
        DB::table('tariff_ya_exyd')->insert($insert_data);
    }
